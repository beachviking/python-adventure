...
import AdventureGameState
from AdventureModel import AdventureModel


class AdventureView:
    
    def __init__(self, outputStream, model: AdventureModel):
    ...
    @property
    def dictionaryForNewUser(self) -> str:
    ...
    def renderWelcomeBanner(self):
        endl = '\n'
        self.buffer.write('gkAdventure, an iteractive fiction interpreter' + endl)
