# Filename: AdventureController.py
# Author: Greg M. Krsak
# License: MIT
...
class AdventureController:
    ...
    def __init__(self, inputStream, model: AdventureModel):
        self.input = inputStream
        self.model = model

    
    def gameStateForUserWithId(self, userId) -> AdventureGameState:
        return self.model.gameStateForNounWithId(userId)


    def setGameStateForUserWithId(self, gameState: AdventureGameState, userId):
    ...
    def parseCommandFromNounWithId(self, commandString, sourceNounId):
        ...
        if self.model.gameStateForNounWithId(sourceNounId) == AdventureGameState.PLAYING:
